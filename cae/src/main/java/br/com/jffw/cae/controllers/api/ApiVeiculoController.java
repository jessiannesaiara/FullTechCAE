...
public class ApiVeiculoController {	
	...
	@CrossOrigin	
	@PutMapping("/{placa}")	public ResponseEntity<String> alterarVeiculo(@RequestBody Map<String, String> dados, @PathVariable String placa) {		
		try {
	...
	@CrossOrigin	
	@DeleteMapping("/{placa}")	public ResponseEntity<String> deleteVeiculo(@PathVariable String placa) {		
		try {
	...
	@CrossOrigin	
	@GetMapping("/{placa}")	public ResponseEntity<?> listarVeiculosPorPlaca(@PathVariable String placa) {
		try {			
